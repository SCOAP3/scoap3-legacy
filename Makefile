...
bibcheck_plugins = crossref_timestamp.py iop_issn.py iop_arxive_fix.py arxiv_prefix.py chk_add_publisher.py chk_fix_cc_by.py chk_add_inspireid.py compliance_check.py chk_fix_latex.py chk_find_erratum.py check_nations.py chk_fix_773_subfields.py
